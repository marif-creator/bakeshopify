  ...
  <div class="space-y-6">
    ...
    <UCard>
      ...
      <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
        <UButton @click="navigateToProducts" variant="outline" class="justify-start" size="lg">
          <UIcon name="i-heroicons-plus-circle" class="w-5 h-5 mr-2" />
          Add New Product
        </UButton>
        <UButton @click="navigateToOrders" variant="outline" class="justify-start" size="lg">
          <UIcon name="i-heroicons-clipboard-document-list" class="w-5 h-5 mr-2" />
          View All Orders
        </UButton>
        <UButton @click="navigateToProfile" variant="outline" class="justify-start" size="lg">
...
const navigateToProducts = () => {
  navigateTo('/seller/dashboard?tab=products')
}

const navigateToOrders = () => {
  navigateTo('/seller/dashboard?tab=orders')
}

const navigateToProfile = () => {
  navigateTo('/seller/dashboard?tab=profile')
}

const navigateToOverview = () => {
  navigateTo('/seller/dashboard/overview')
}
